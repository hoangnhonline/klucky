                ...
                <div class="modal-content kl_modal_content kl_modal_betterlucknexttime kl_modal_submit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="kl_modal_video">
                            <iframe width="550" height="350" src="https://www.youtube.com/embed/{{ $settingArr['youtube_id'] }}?rel=0" frameborder="0" allowfullscreen id="load_video"></iframe>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered kl_modal" role="document">
                <div class="modal-content kl_modal_content kl_modal_betterlucknexttime">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="kl_modal_video">
                            <iframe width="550" height="350" src="https://www.youtube.com/embed/{{ $settingArr['youtube_id_losing'] }}?rel=0" frameborder="0" allowfullscreen id="load_video"></iframe>
                        </div>
